    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-xs-12 col-sm-3 col-md-3">
                ...
                <div class="logo">
                    <a href="index.html">
                        <img src="{{Asset('asset/frontend/images/logos/logo.png')}}" alt=""> <!-- Replace Logo Here -->
                    </a>
                </div>
                <!-- End Logo -->
            </div>
            <div class="col-xs-12 col-sm-9 col-md-9">
                <div class="top-ad-banner float-right">
                    <a href="#">
                        <img src="{{Asset('asset/frontend/images/news/ad-pro.png')}}" class="img-fluid" alt="banner-ads">
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="row no-gutters">
            <div class="col-md-6 col-xs-12 col-lg-4">
                <div class="featured-slider mr-md-3 mr-lg-3">
                    <div class="item" style="{{asset('asset/frontend/background-image:url(images/news/img-1.jpg)')}}">
                        <div class="post-content">
            ...
            <div class="col-md-6 col-xs-12 col-lg-4">
                 <div class="featured-slider mr-lg-3">
                    <div class="item" style="{{Asset('asset/frontend/background-image:url(images/news/img-2.jpg)')}}">
                        <div class="post-content">
            ...
            <div class="col-md-12 col-xs-12 col-sm-12 col-lg-4">
                <div class="row mt-3 mt-lg-0">
                    <div class="col-lg-12 col-xs-12 col-sm-6 col-md-6">
                        <div class="post-featured-style" style="{{Asset('asset/frontend/background-image:url(images/news/news-02.jpg)')}}">
                            <div class="post-content">
    ...
    <div class="news-style-one-slide">
        <div class="item">
            <div class="post-block-wrapper clearfix mb-5">
                <div class="post-thumbnail">
                    <a href="single-post.htm">
                        <img class="{{Asset('asset/frontend/img-fluid')}}" src="{{Asset('asset/frontend/images/news/news-01.jpg')}}" alt="post-image"/>
                    </a>
                </div>
                <div class="post-content">
            ...
            <div class="post-block-wrapper clearfix mb-5 ">
                <div class="post-thumbnail">
                    <a href="single-post.htm">
                        <img class="img-fluid" src="{{Asset('asset/frontend/images/news/news-02.jpg')}}" alt="post-thumbnail"/>
                    </a>
                </div>
                <div class="post-content">
                    <h2 class="post-title">
        ...
        <div class="item">
            <div class="post-block-wrapper clearfix mb-5">
                <div class="post-thumbnail">
                    <a href="single-post.htm">
                        <img class="img-fluid" src="{{Asset('asset/frontend/images/news/news-03.jpg')}}" alt="post-thumbnail"/>
                    </a>
                </div>
                <div class="post-content">
                    <h2 class="post-title ">
            ...
            <div class="post-block-wrapper clearfix mb-5">
                <div class="post-thumbnail">
                    <a href="single-post.htm">
                        <img class="img-fluid" src="{{Asset('asset/frontend/images/news/news-04.jpg')}}" alt="post-thumbnail"/>
                    </a>
                </div>
                <div class="post-content">
        ...
        <div class="item">
            <div class="post-block-wrapper clearfix  mb-5">
                <div class="post-thumbnail">
                    <a href="single-post.htm">
                        <img class="img-fluid" src="{{Asset('asset/frontend/images/news/news-05.jpg')}}" alt="post-thumbnail"/>
                    </a>
                </div>
                <div class="post-content">
                    <h2 class="post-title">
            ...
            <div class="post-block-wrapper clearfix  mb-5">
                <div class="post-thumbnail">
                    <a href="single-post.htm">
                        <img class="img-fluid" src="{{Asset('asset/frontend/images/news/news-06.jpg')}}" alt="post-thumbnail"/>
                    </a>
                </div>
                <div class="post-content">
                    <h2 class="post-title">
        ...
        <div class="item">
            <div class="post-block-wrapper clearfix  mb-5">
                <div class="post-thumbnail">
                    <a href="single-post.htm">
                        <img class="img-fluid" src=""{{Asset('asset/frontend/images/news/news-07.jpg')}}" alt="post-thumbnail"/>
                    </a>
                </div>
                <div class="post-content">
                    <h2 class="post-title">
            ...
            <div class="post-block-wrapper clearfix  mb-5">
                <div class="post-thumbnail">
                    <a href="single-post.htm">
                        <img class="img-fluid" src="{{Asset('asset/frontend/images/news/news-08.jpg')}}" alt="post-thumbnail"/>
                    </a>
                </div>
                <div class="post-content">
                    <h2 class="post-title">
            ...
            <div class="post-block-wrapper clearfix">
                <div class="post-thumbnail">
                    <a href="single-post.html">
                        <img class="img-fluid" src="{{Asset('asset/frontend/images/news/news-09.jpg')}}" alt="post-thumbnail"/>
                    </a>
                </div>
        ...
        <div class="col-md-6 col-sm-6">
            <div class="post-list-block m-top-0">
                <div class="post-block-wrapper post-float clearfix">
                    <div class="post-thumbnail">
                        <a href="single-post.html">
                            <img class="img-fluid" src="{{Asset('asset/frontend/mages/news/news-04.jpg')}}" alt="post-thumbnail"/>
                        </a>
                    </div>
